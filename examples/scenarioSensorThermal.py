...
The script is found in the folder ``basilisk/examples`` and executed by using::
    ...
    python3 scenarioThermalSensor.py

Detailed description. :ref:`locationPointing`, ``attGuidOutMsg``.
...
.. image:: /_images/Scenarios/scenarioThermalSensor1.svg
   :align: center
...
def run(show_plots):
    ...
    thermalSensor.T_0 = 0
    thermalSensor.setSensorParameters(nHat_B, sensorArea, sensorAbsorptivity, sensorEmissivity, sensorMass, sensorSpecificHeat)
