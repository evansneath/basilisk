...
public:
    ...
    void setSensorParameters(Eigen::Vector3d nHat_B, double sensorArea, double sensorAbsorptivity, double sensorEmissivity, double sensorMass, double sensorSpecificHeat);
...
public:
    ...
    double sensorSpecificHeat;                  //!< [J/kg/J] Sensor specific heat
