...
/*!
 *  This method allows for the sensor-specific parameters to be set
 * @param nHat_B: normal direction of the sensor in the spacecraft body frame
 * @param sensorArea: area of the sensor (units m^2), assumed to be a flat plate
 * @param sensorAbsorptivity: coefficient of the sensor absorptivity (unitless, between 0 and 1)
 * @param sensorEmissivity: coefficient of the sensor emissivity (unitless, between 0 and 1)
 * @param sensorMass: mass of the sensor (kg)
 * @param sensorSpecificHeat: specific heat of the material of the sensor (units J/kg/C)
 */
void SensorThermal::setSensorParameters(Eigen::Vector3d nHat_B, double sensorArea, double sensorAbsorptivity, double sensorEmissivity, double sensorMass, double sensorSpecificHeat)
{
    this->nHat_B = nHat_B;
    this->sensorArea = sensorArea;
    this->sensorAbsorptivity = sensorAbsorptivity;
    this->sensorEmissivity = sensorEmissivity;
    this->sensorMass = sensorMass;
    this->sensorSpecificHeat = sensorSpecificHeat;
    return;
}
